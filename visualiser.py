...
Functions equivalently to the Tester script, but shows a visualisation of the state after each action is performed. This
may be useful for debugging output files generated by your solution.
